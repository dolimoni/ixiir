<div class='col-md-12'>
    <div class='posty' id="dv_post_{{$post['post_id']}}">
        ...
        <div  class='comment-section' style="display: block" id="cacher_comment_{{$post['post_id']}}">

            <div class='comment-sec'>

                <ul dir="rtl" lang="ar" id="ul_cmentaire_{{$post['post_id']}}" >
            ...
            <div class='post-comment'>
                ...
                <div class='comment_box'>
                    ...
                    @if(Auth::check())
                        ...
                        <input type='text' id="txt_comentaire_{{$post['post_id']}}" placeholder="Your comment" required />
