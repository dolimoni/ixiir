...
<div class="wrapper">
	...
	<nav class="main-header navbar navbar-expand navbar-white navbar-light">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item dropdown">
				<a class="hidden nav-link" data-toggle="dropdown" href="#">
					<i class="far fa-comments"></i>
					<span class="badge badge-danger navbar-badge">3</span>
				</a>
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
					<a hidden href="#" class="dropdown-item dropdown-footer">Voir tous les chèques</a>
				</div>
			</li>
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="#" class="brand-link">
			<img hidden src="{{asset('adminAsset/images/Unknown-person.gif')}}" alt="logo" class="brand-image img-circle elevation-3"
				 style="opacity: .8">
			<span class="brand-text font-weight-light">IXIIR</span>
		</a>
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img hidden src="{{asset('adminAsset/images/Unknown-person.gif')}}" class="img-circle elevation-2" alt="logo">
				</div>
				<div class="info">
